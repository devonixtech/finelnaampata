    ...
    try {
        ...
        if (bizTable) {
            ...
            const missingColumns = [
                ...
                { name: 'target_market', type: 'jsonb', default: '\'[]\'' },
                { name: 'location_access', type: 'jsonb', default: '\'[]\'' },
                { name: 'facilities', type: 'jsonb', default: '\'[]\'' },
                { name: 'staff_features', type: 'jsonb', default: '\'[]\'' },
                { name: 'payment_methods', type: 'jsonb', default: '\'[]\'' },
                { name: 'industry_sub_type', type: 'jsonb', default: '\'[]\'' },
                { name: 'franchise_opportunities', type: 'boolean', default: 'false' },
                { name: 'franchise_available_in', type: 'jsonb', default: '\'[]\'' },
                { name: 'franchise_investment_range', type: 'varchar(50)', nullable: true },
                { name: 'franchise_support', type: 'jsonb', default: '\'[]\'' },
                { name: 'franchise_min_space', type: 'varchar(50)', nullable: true },
                { name: 'looking_for_dealers', type: 'boolean', default: 'false' },
                { name: 'is_importer_exporter', type: 'boolean', default: 'false' },
                { name: 'areas_served', type: 'jsonb', default: '\'[]\'' },
                { name: 'business_languages', type: 'jsonb', default: '\'[]\'' },
                { name: 'chain_or_multiple_branches', type: 'boolean', default: 'false' },
                { name: 'social_links', type: 'jsonb', default: '\'[]\'' },
                { name: 'has_offer', type: 'boolean', default: 'false' },
                { name: 'offer_title', type: 'varchar(150)', nullable: true },
                { name: 'offer_description', type: 'text', nullable: true },
                { name: 'offer_badge', type: 'varchar(60)', nullable: true },
                { name: 'offer_expires_at', type: 'timestamp', nullable: true },
                { name: 'offer_banner_url', type: 'text', nullable: true },
                { name: 'albums', type: 'jsonb', default: '\'[]\'' },
                { 
                    name: 'location', 
