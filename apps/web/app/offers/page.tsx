...
const OffersContent = () => {
    ...
    const fetchOffers = async () => {
        ...
        try {
            ...
            const result = await api.deals.search(params);
            const items = (result?.data || []).map((item: any) => ({ ...item, type: 'offer' as const }));
            setOffers(items);
            ...
            <div className="bg-white border-b border-slate-50 pt-10 pb-12 lg:pt-10 lg:pb-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-slate-300 mb-10">
                        ...
                        <span className="text-slate-900">Offers</span>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
                        ...
                        <div className="flex items-center gap-8 bg-[#F8FAFC] p-8 rounded-[20px] border border-slate-100/50">
                            <div>
                                ...
                                <div className="text-[10px] font-black uppercase tracking-widest text-slate-400">Offers Found</div>
                            </div>
                        ...
                        <div className="sticky top-28 space-y-12">
                            <div>
                                <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-300 mb-8 flex items-center gap-2">
                                    <Tag className="w-3.5 h-3.5" /> Refine Offers
                                </h3>
                    ...
                    <div className="lg:col-span-9">
                        ...
                        {loading ? (
                            <div className="py-40 flex flex-col items-center justify-center gap-6">
                                ...
                                <p className="text-slate-400 font-black uppercase tracking-[0.2em] text-[10px]">Finding Best Offers</p>
                            </div>
                        ) : offers.length > 0 ? (
                            <>
    ...
    return (
        <Suspense fallback={
            <div className="min-h-screen flex flex-col items-center justify-center bg-white">
                ...
                <p className="text-slate-400 font-black uppercase tracking-[0.2em] text-[10px]">Loading Offers</p>
            </div>
        }>
            <OffersContent />
        </Suspense>
