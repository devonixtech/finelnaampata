...
export default function BusinessDetailClient({
  ...
  const handleContactIntent = async (
    ...
    try {
      ...
      if (action === "call" && business?.phone) {
        ...
        const waNumber = ((business as any).whatsapp || business.phone).replace(
          /\s+/g,
          "",
        );
        window.open(
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="lg:col-span-2">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
              <div>
                ...
                {((business.vendor as any)?.tagline || (business as any).tagline) && (
              ...
              <div className="bg-light rounded-[30px] p-10 border border-slate-100 transition-all   duration-500">
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="flex items-center justify-center gap-3 mt-2 mb-4 w-full">
                    {((business.vendor as any)?.whatsapp || (business as any).whatsapp) && (
                      <a href={`https://wa.me/${((business.vendor as any)?.whatsapp || (business as any).whatsapp).replace(/[^0-9]/g, '')}?text=Hi, I found your business on Nampata.`} target="_blank" rel="noopener noreferrer" className="p-3 bg-green-50 text-green-600 rounded-xl hover:bg-green-100 hover:-translate-y-1 transition-all duration-300 shadow-sm hover:shadow-green-500/20" title="WhatsApp">
                        <MessageSquare className="w-5 h-5" />
                      </a>
                    )}
                    {((business.vendor as any)?.businessEmail || (business as any).email) && (
                      <a href={`mailto:${(business.vendor as any)?.businessEmail || (business as any).email}`} className="p-3 bg-blue-50 text-blue-600 rounded-xl hover:bg-blue-100 hover:-translate-y-1 transition-all duration-300 shadow-sm hover:shadow-blue-500/20" title="Email Business">
      ...
      {/* ΓöÇΓöÇ Special Offers & Events ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      {offers.length > 0 && (
